...
public class NotificationServiceTest {
    ...
    // Helper – builds a Notification entity with message and email
    ...
    // ──────────────────────────────────────────────────────────────
    // TEST 1
    // Method : getUserNotifications(String email)
    // Checks : returns a list of 2 NotificationDTOs when 2 exist
    // ──────────────────────────────────────────────────────────────
    @Test
    ...
    // TEST 2
    // Method : getUserNotifications(String email)
    // Checks : returns empty list (not null) when user has no notifications
    // ──────────────────────────────────────────────────────────────
    @Test
    ...
    // TEST 3
    // Method : getUserNotifications(String email)
    // Checks : the repository is called with the EXACT email that was passed
    // ──────────────────────────────────────────────────────────────
    @Test
    public void testGetUserNotificationsByEmail_RepositoryCalledWithCorrectEmail() {
        ...
        // Verify repository was called with exactly "user@test.com"
    ...
    // TEST 4
    // Method : getUserNotifications(String email)
    // Checks : the message inside the DTO matches the entity's message
    // ──────────────────────────────────────────────────────────────
    @Test
    ...
    // ──────────────────────────────────────────────────────────────
    // TEST 5
    // Method : getUserNotifications(Long userId)
    // Checks : this is an unimplemented TODO stub — it must return null
    //          (verifies the stub behaves as expected without crashing)
    // ──────────────────────────────────────────────────────────────
    @Test

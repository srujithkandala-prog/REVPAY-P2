...
public class MoneyRequestController {
    ...
    public String outgoingRequests(Model model,
        ...
        // FIXED LINE (changed receiverEmail → requesterEmail)
        List<MoneyRequest> requests =
                moneyRequestRepository
